...
// }
//
// man4FullCopy.mother.work.experience = 77
// console.log(man4)
...
// }
//
// man5FullCopy.mother.work.position = 'policeman'
// man5FullCopy.mother.parents[1].name = 'Elena'
// console.log(man5)
...
// }
//
// man6FullCopy.mother.parents[1].favoriteDish.title = 'pasta'
// console.log(man6)
...
let man7FullCopy = {
    ...
    mother: {
        ...
        parents: man7.mother.parents.map(el => ({
            ...
            favoriteDish: {
                ...el.favoriteDish,
                ingredients: el.favoriteDish.ingredients.map(ingr => ({...ingr}))
            }
        }))
    }
}

man7FullCopy.mother.parents[1].favoriteDish.ingredients[0].title = 'meat'
console.log(man7)
